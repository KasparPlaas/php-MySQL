...
// 3. Leia kasutaja andmed (ainult klient)
$email = "";
$eesnimi = "";
$perenimi = "";
$telefon = "";
...
// Kliendi andmed (sisselogitud)
$klient_query = mysqli_query($yhendus, 
    "SELECT kliendid.eesnimi, kliendid.perenimi, kliendid.telefon, kliendid.isikukood, kasutajad.email 
     FROM kliendid
     JOIN kasutajad ON kliendid.kasutaja_id = kasutajad.id
     WHERE kasutajad.id = ".$_SESSION['kasutaja_id']);
    
if ($klient = mysqli_fetch_assoc($klient_query)) {
    $email = $klient['email'];
    $eesnimi = $klient['eesnimi'];
    $perenimi = $klient['perenimi'];
    $telefon = $klient['telefon'];
    $isikukood = $klient['isikukood'];
}
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-header bg-light">
                            <h4 class="mb-0"><i class="bi bi-person me-2"></i>Kliendi info</h4>
                        </div>
                        <div class="card-body">
